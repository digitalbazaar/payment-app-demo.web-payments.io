/*
 * payment-app-demo.payment-app-demo.web-payments.io test configuration.
 *
...
config.loggers.app.filename = _logdir + '/payment-app-demo.web-payments.io-test-app.log';
config.loggers.access.filename = _logdir + '/payment-app-demo.web-payments.io-test-access.log';
config.loggers.error.filename = _logdir + '/payment-app-demo.web-payments.io-test-error.log';
...
config.server.host = 'payment-app-demo.web-payments.dev:54443';
...
protractor.suites['payment-app-demo.web-payments.io'] = path.join(
